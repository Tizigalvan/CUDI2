...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2025 a las 17:56:05
...
CREATE TABLE `itinerario` (
  ...
  `todoelturno` varchar(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `itinerario` (`id_itinerario`, `hora_fin`, `hora_inicio`, `turno_id`, `todoelturno`) VALUES
(1, '11:00:00', '09:00:00', 1, 'no'),
(2, '12:45:00', '11:00:00', 1, 'no'),
(3, '15:30:00', '13:30:00', 2, 'no'),
(4, '17:45:00', '15:30:00', 2, 'no'),
(5, '20:00:00', '18:30:00', 3, 'no'),
(6, '22:30:00', '20:00:00', 3, 'no'),
(7, '12:45:00', '08:00:00', 1, 'si'),
(8, '13:30:00', '17:45:00', 2, 'si'),
(9, '22:30:00', '18:30:00', 3, 'si');
...
(1201, 'Anátomo-Fisiología I', 8, NULL, 2),
...
INSERT INTO `materia_profesor` (`materia_id`, `profesor_id`) VALUES
(1, 1),
(1, 2),
(2, 1),
(2, 2),
...
(13, '2025-09-27', '1', 2, 3, 1201, 23, 1, 'activa', '2025-09-25 16:04:07'),
(14, '2025-10-09', '90', 1, 1, 1201, 1, 2, 'activa', '2025-10-06 15:36:04'),
(15, '2025-10-16', '20', 1, 7, 1201, 22, 2, 'activa', '2025-10-06 15:47:34');
...
ALTER TABLE `materia_profesor`
  ADD PRIMARY KEY (`materia_id`,`profesor_id`),
  ADD KEY `fk_mp_profesor` (`profesor_id`);
...
--
ALTER TABLE `materia_profesor`
  ADD CONSTRAINT `fk_mp_materia` FOREIGN KEY (`materia_id`) REFERENCES `materias` (`id_materia`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_mp_profesor` FOREIGN KEY (`profesor_id`) REFERENCES `profesores` (`id_profesor`) ON DELETE CASCADE,
  ADD CONSTRAINT `materia_profesor_ibfk_1` FOREIGN KEY (`materia_id`) REFERENCES `materias` (`id_materia`) ON DELETE CASCADE,
  ADD CONSTRAINT `materia_profesor_ibfk_2` FOREIGN KEY (`profesor_id`) REFERENCES `profesores` (`id_profesor`) ON DELETE CASCADE;
